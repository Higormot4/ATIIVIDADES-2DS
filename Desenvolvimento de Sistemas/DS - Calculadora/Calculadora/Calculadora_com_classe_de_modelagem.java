 ...
 * @author Higor
 */
public class Calculadora_com_classe_de_modelagem {
    ...
    public Calculadora_com_classe_de_modelagem() {
        this(0, 0, 0);
    }

    public Calculadora_com_classe_de_modelagem(double n1, double n2, double r) {
        this.n1 = n1;
        this.n2 = n2;
        this.r = r;
    }
...
public void subtrair(double valor1, double valor2) {
    ...
    setR(getN1() - getN2());
             JOptionPane.showMessageDialog(null,"A subtração do dois números é:"+getR ());
